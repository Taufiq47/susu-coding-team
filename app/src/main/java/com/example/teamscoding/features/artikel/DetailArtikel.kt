    ...
    LazyColumn(
        ...
        item {
            Column {
                ...
                Text(
                    "Mendampingi anak balita memerlukan kesabaran, kasih sayang, dan perhatian. Dengan memberikan lingkungan yang mendukung, orang tua dapat membantu anak tumbuh menjadi individu yang sehat, cerdas, dan percaya diri. Jangan ragu untuk mencari bantuan profesional jika diperlukan, seperti dokter anak atau psikolog, untuk memastikan anak mendapatkan perawatan terbaik.",
                    color = GreenText,
                    style = TextStyle(
                        fontSize = 12.sp,
                        fontFamily = poppinsFontFamily,
